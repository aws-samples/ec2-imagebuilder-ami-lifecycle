...
class ConstantsService:
    ...
    STACK_NAME_IMAGEBUILDER = os.environ['STACK_NAME_IMAGEBUILDER']
    STACK_NAME_AMI_LIFECYCLE = os.environ['STACK_NAME_AMI_LIFECYCLE']

    # State machine max wait time
    STATE_MACHINE_MAX_WAIT_TIME = int(os.environ['STATE_MACHINE_MAX_WAIT_TIME'])
    ...
    CLOUDFORMATION_STACK_IMAGEBUILDER = "IMAGE_BUILDER"
